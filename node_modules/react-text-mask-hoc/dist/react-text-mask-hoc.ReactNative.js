...
var TextInputAdapter = function (_PureComponent) {
    inherits(TextInputAdapter, _PureComponent);
    ...
    function TextInputAdapter() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = TextInputAdapter.__proto__ || Object.getPrototypeOf(TextInputAdapter)).call.apply(_ref, [this].concat(args))), _this), _this._wait = false, _this._getRef = function (ref) {
            _this.input = ref;
        }, _this._onChange = function (_ref2) {
            var nativeEvent = _ref2.nativeEvent;

            _this._lastOnChangeEvent = nativeEvent;
        }, _this._onSelectionChange = function (_ref3) {
            var nativeEvent = _ref3.nativeEvent;

            // Throttle events because they are called multiple times for an unknown reason.
            if (_this._wait) return;
            _this._wait = true;
            setTimeout(function () {
                _this._wait = false;
            }, 100);
            ...
            _this._selection = nativeEvent.selection;
            if (_this._lastOnChangeEvent && _this._lastOnChangeEvent.text !== _this.props.value) {
                _this.props.onChange(_this._lastOnChangeEvent);
                _this._lastOnChangeEvent = null;
            } else {
                _this.forceUpdate();
            }
...
var TextAdapter = function (_PureComponent2) {
    inherits(TextAdapter, _PureComponent2);
...
TextAdapter.propTypes = {
    value: PropTypes.string.isRequired,
    caretPosition: PropTypes.number.isRequired,
    onChange: PropTypes.func.isRequired
};

export { createMaskedComponent, TextInputAdapter, TextAdapter, TextMaskElement };
