...
function conformToMask() {
  ...
  var _config$guide = config.guide,
      ...
      previousConformedValue = _config$previousConfo === undefined ? emptyString$1 : _config$previousConfo,
      _config$placeholderCh = config.placeholderChar,
      placeholderChar$$1 = _config$placeholderCh === undefined ? placeholderChar : _config$placeholderCh,
      _config$placeholder = config.placeholder,
      placeholder = _config$placeholder === undefined ? convertMaskToPlaceholder(mask, placeholderChar$$1) : _config$placeholder,
...
var TextMaskElement = function () {
    function TextMaskElement() {
        classCallCheck(this, TextMaskElement);
        this.previousRawValue = undefined;
        this.previousConformedValue = undefined;
        this.previousPlaceholder = undefined;
    }

    createClass(TextMaskElement, [{
        key: 'update',
        value: function update(_ref) {
            var rawValue = _ref.value,
                ...
                placeholderChar$$1 = _ref$placeholderChar === undefined ? placeholderChar : _ref$placeholderChar,
            ...
            if (providedMask != null && (typeof providedMask === 'undefined' ? 'undefined' : _typeof(providedMask)) === 'object' && providedMask.pipe != null && providedMask.mask != null) {
    ...
    return TextMaskElement;
}();

/* eslint-disable import/no-extraneous-dependencies */

var createMaskedComponent = (function (WrappedComponent) {
    ...
    return _temp = _class = function (_PureComponent) {
        ...
        function TextMask(props, context) {
            ...
            var _this = possibleConstructorReturn(this, (TextMask.__proto__ || Object.getPrototypeOf(TextMask)).call(this, props, context));

            _initialiseProps.call(_this);

            _this.component = null;
            _this.textMaskElement = null;

            _this.textMaskElement = new TextMaskElement();
            var nextUpdate = _this._update(_this.props);
        ...
        createClass(TextMask, [{
            ...
            value: function componentWillReceiveProps(nextProps) {
                var nextUpdate = this._update(nextProps);
            ...
            value: function render() {
                var _props = this.props,
                    ...
                    rest = objectWithoutProperties(_props, ['value', 'mask', 'guide', 'pipe', 'placeholderChar', 'keepCharPositions', 'showMask', 'componentRef', 'onChange']);


                return React__default.createElement(WrappedComponent, _extends({}, rest, {
        ...
        this._update = function (props) {
            return _this2.textMaskElement.update({
                value: props.value,
        ...
        this._onChange = function (event) {
            if (event) {
                var rawValue = event.target != null && _typeof(event.target) === 'object' ? event.target.value : event.text;
                var nextUpdate = _this2._update(_extends({}, _this2.props, { value: rawValue }));
                if (nextUpdate !== null) {
                    _this2.setState(nextUpdate);
                }
...
var InputAdapter = function (_PureComponent) {
    ...
    function InputAdapter() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = InputAdapter.__proto__ || Object.getPrototypeOf(InputAdapter)).call.apply(_ref, [this].concat(args))), _this), _this._getRef = function (ref) {
            _this.input = ref;
        }, _this._setCaretPosition = function () {
            _this.input.setSelectionRange(_this.props.caretPosition, _this.props.caretPosition, 'none');
    ...
    createClass(InputAdapter, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = objectWithoutProperties(_props, ['caretPosition']);


            return React__default.createElement('input', _extends({ ref: this._getRef }, rest));
        }
    }, {
        key: 'caretPosition',
        get: function get$$1() {
...
var SpanAdapter = function (_PureComponent2) {
    inherits(SpanAdapter, _PureComponent2);
    ...
    createClass(SpanAdapter, [{
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                rest = objectWithoutProperties(_props2, ['value', 'caretPosition', 'onChange']);
...
SpanAdapter.propTypes = {
    value: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
    caretPosition: PropTypes.number.isRequired,
    onChange: PropTypes.func.isRequired
};

exports.createMaskedComponent = createMaskedComponent;
exports.InputAdapter = InputAdapter;
exports.SpanAdapter = SpanAdapter;
exports.TextMaskElement = TextMaskElement;
